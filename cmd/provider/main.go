...
import (
	...
	apisCluster "github.com/Cube-Asia/provider-upjet-snowflake/apis/cluster"
	apisNamespaced "github.com/Cube-Asia/provider-upjet-snowflake/apis/namespaced"
	"github.com/Cube-Asia/provider-upjet-snowflake/config"
	"github.com/Cube-Asia/provider-upjet-snowflake/internal/clients"
	controllerCluster "github.com/Cube-Asia/provider-upjet-snowflake/internal/controller/cluster"
	controllerNamespaced "github.com/Cube-Asia/provider-upjet-snowflake/internal/controller/namespaced"
	"github.com/Cube-Asia/provider-upjet-snowflake/internal/features"
	"github.com/Cube-Asia/provider-upjet-snowflake/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Snowflake APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Snowflake APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Snowflake controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Snowflake controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Snowflake controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Snowflake controllers")
	}
