...
// Configure configures the stable user resource group (cluster-scoped).
// Contains resources with subcategory "Stable" that manage Snowflake users and
// user-related objects (authentication, tokens, policies).
