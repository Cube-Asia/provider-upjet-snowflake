...
type OrganizationAccountObservation struct {
	...
	ShowOutput []OrganizationAccountShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type OrganizationAccountShowOutputInitParameters struct {
}

type OrganizationAccountShowOutputObservation struct {
...
type OrganizationAccountShowOutputParameters struct {
}
