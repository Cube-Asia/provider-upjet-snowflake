...
type Saml2IntegrationDescribeOutputCommentInitParameters struct {
}

type Saml2IntegrationDescribeOutputCommentObservation struct {
...
type Saml2IntegrationDescribeOutputCommentParameters struct {
}

type Saml2IntegrationDescribeOutputInitParameters struct {
}

type Saml2IntegrationDescribeOutputObservation struct {
	...
	Comment []Saml2IntegrationDescribeOutputCommentObservation `json:"comment,omitempty" tf:"comment,omitempty"`
...
type Saml2IntegrationDescribeOutputParameters struct {
}

type Saml2IntegrationInitParameters struct {
	...
	Saml2X509CertSecretRef v1.LocalSecretKeySelector `json:"saml2X509CertSecretRef" tf:"-"`
}
...
type Saml2IntegrationObservation struct {
	...
	DescribeOutput []Saml2IntegrationDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []Saml2IntegrationShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}

type Saml2IntegrationParameters struct {
...
type Saml2IntegrationShowOutputObservation struct {
...
type Saml2IntegrationShowOutputParameters struct {
}
...
type Saml2IntegrationSpec struct {
	...
	// autoscaler.
	InitProvider Saml2IntegrationInitParameters `json:"initProvider,omitempty"`
}
...
// Saml2Integration is the Schema for the Saml2Integrations API. Resource used to manage SAML2 security integration objects. For more information, check security integrations documentation https://docs.snowflake.com/en/sql-reference/sql/create-security-integration-saml2.
...
type Saml2Integration struct {
	...
	Spec   Saml2IntegrationSpec   `json:"spec"`
	Status Saml2IntegrationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// Saml2IntegrationList contains a list of Saml2Integrations
...
var (
	Saml2Integration_Kind             = "Saml2Integration"
	Saml2Integration_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Saml2Integration_Kind}.String()
	Saml2Integration_KindAPIVersion   = Saml2Integration_Kind + "." + CRDGroupVersion.String()
	Saml2Integration_GroupVersionKind = CRDGroupVersion.WithKind(Saml2Integration_Kind)
)
