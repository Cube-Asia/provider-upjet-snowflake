...
type MonitorObservation struct {
	...
	ShowOutput []MonitorShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type MonitorShowOutputInitParameters struct {
}

type MonitorShowOutputObservation struct {
...
type MonitorShowOutputParameters struct {
}
