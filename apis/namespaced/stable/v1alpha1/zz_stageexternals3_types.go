...
type StageExternalS3CredentialsInitParameters struct {
	...
	AwsKeyIDSecretRef *v2.LocalSecretKeySelector `json:"awsKeyIdSecretRef,omitempty" tf:"-"`
	...
	AwsSecretKeySecretRef *v2.LocalSecretKeySelector `json:"awsSecretKeySecretRef,omitempty" tf:"-"`
	...
	AwsTokenSecretRef *v2.LocalSecretKeySelector `json:"awsTokenSecretRef,omitempty" tf:"-"`
}
...
type StageExternalS3InitParameters struct {
	...
	// uses special value that cannot be set in the configuration manually (default)) Specifies whether to use a private link endpoint for S3 storage.
	// Specifies whether to use a private link endpoint for S3 storage.
