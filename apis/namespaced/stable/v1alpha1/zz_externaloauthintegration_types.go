...
type ExternalOauthIntegrationDescribeOutputCommentInitParameters struct {
}

type ExternalOauthIntegrationDescribeOutputCommentObservation struct {
...
type ExternalOauthIntegrationDescribeOutputCommentParameters struct {
}

type ExternalOauthIntegrationDescribeOutputEnabledInitParameters struct {
}

type ExternalOauthIntegrationDescribeOutputEnabledObservation struct {
...
type ExternalOauthIntegrationDescribeOutputEnabledParameters struct {
}

type ExternalOauthIntegrationDescribeOutputInitParameters struct {
}

type ExternalOauthIntegrationDescribeOutputObservation struct {

	// (String) Specifies a comment for the OAuth integration.
	Comment []ExternalOauthIntegrationDescribeOutputCommentObservation `json:"comment,omitempty" tf:"comment,omitempty"`

	// (Boolean) Specifies whether to initiate operation of the integration or suspend it.
	Enabled []ExternalOauthIntegrationDescribeOutputEnabledObservation `json:"enabled,omitempty" tf:"enabled,omitempty"`
...
type ExternalOauthIntegrationDescribeOutputParameters struct {
}

type ExternalOauthIntegrationInitParameters struct {
...
type ExternalOauthIntegrationObservation struct {
	...
	DescribeOutput []ExternalOauthIntegrationDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []ExternalOauthIntegrationShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}

type ExternalOauthIntegrationParameters struct {
...
type ExternalOauthIntegrationShowOutputInitParameters struct {
}

type ExternalOauthIntegrationShowOutputObservation struct {
...
type ExternalOauthIntegrationShowOutputParameters struct {
}
...
// ExternalOauthIntegrationSpec defines the desired state of ExternalOauthIntegration
type ExternalOauthIntegrationSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ExternalOauthIntegrationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalOauthIntegrationInitParameters `json:"initProvider,omitempty"`
}
...
// ExternalOauthIntegration is the Schema for the ExternalOauthIntegrations API. Resource used to manage external oauth security integration objects. For more information, check security integrations documentation https://docs.snowflake.com/en/sql-reference/sql/create-security-integration-oauth-external.
...
type ExternalOauthIntegration struct {
	...
	Spec   ExternalOauthIntegrationSpec   `json:"spec"`
	Status ExternalOauthIntegrationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalOauthIntegrationList contains a list of ExternalOauthIntegrations
...
var (
	ExternalOauthIntegration_Kind             = "ExternalOauthIntegration"
	ExternalOauthIntegration_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalOauthIntegration_Kind}.String()
	ExternalOauthIntegration_KindAPIVersion   = ExternalOauthIntegration_Kind + "." + CRDGroupVersion.String()
	ExternalOauthIntegration_GroupVersionKind = CRDGroupVersion.WithKind(ExternalOauthIntegration_Kind)
)
