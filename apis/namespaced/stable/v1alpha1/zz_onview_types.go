...
type OnViewAtInitParameters struct {
...
type OnViewAtObservation struct {
...
type OnViewAtParameters struct {
...
type OnViewBeforeInitParameters struct {
...
type OnViewBeforeObservation struct {
...
type OnViewBeforeParameters struct {
...
type OnViewDescribeOutputInitParameters struct {
}

type OnViewDescribeOutputObservation struct {
...
type OnViewDescribeOutputParameters struct {
}
...
type OnViewInitParameters struct {
	...
	At []OnViewAtInitParameters `json:"at,omitempty" tf:"at,omitempty"`
	...
	Before []OnViewBeforeInitParameters `json:"before,omitempty" tf:"before,omitempty"`
...
type OnViewObservation struct {
	...
	// (see below for nested schema)
	// This field specifies that the request is inclusive of any changes made by a statement or transaction with a timestamp equal to the specified parameter. Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	At []OnViewAtObservation `json:"at,omitempty" tf:"at,omitempty"`

	// (see below for nested schema)
	// This field specifies that the request refers to a point immediately preceding the specified parameter. This point in time is just before the statement, identified by its query ID, is completed.  Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	Before []OnViewBeforeObservation `json:"before,omitempty" tf:"before,omitempty"`
	...
	DescribeOutput []OnViewDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []OnViewShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type OnViewParameters struct {
	...
	// This field specifies that the request is inclusive of any changes made by a statement or transaction with a timestamp equal to the specified parameter. Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	// +kubebuilder:validation:Optional
	At []OnViewAtParameters `json:"at,omitempty" tf:"at,omitempty"`

	// (see below for nested schema)
	// This field specifies that the request refers to a point immediately preceding the specified parameter. This point in time is just before the statement, identified by its query ID, is completed.  Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	// +kubebuilder:validation:Optional
	Before []OnViewBeforeParameters `json:"before,omitempty" tf:"before,omitempty"`
...
type OnViewShowOutputInitParameters struct {
}

type OnViewShowOutputObservation struct {
...
type OnViewShowOutputParameters struct {
}
