...
type AccountInitParameters_2 struct {
...
type AccountObservation_2 struct {
...
type AccountParameters_2 struct {
...
type AccountSpec struct {
	...
	ForProvider            AccountParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AccountInitParameters_2 `json:"initProvider,omitempty"`
}

// AccountStatus defines the observed state of Account.
type AccountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AccountObservation_2 `json:"atProvider,omitempty"`
}
