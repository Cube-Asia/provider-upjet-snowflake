...
type GitRepositoryDescribeOutputObservation struct {
...
type GitRepositoryDescribeOutputParameters struct {
}
...
type GitRepositoryObservation struct {
	...
	DescribeOutput []GitRepositoryDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []GitRepositoryShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}
...
type GitRepositoryShowOutputInitParameters struct {
}

type GitRepositoryShowOutputObservation struct {
...
type GitRepositoryShowOutputParameters struct {
}
...
// GitRepository is the Schema for the GitRepositorys API. Resource used to manage git repositories. For more information, check git repositories documentation https://docs.snowflake.com/en/sql-reference/sql/create-git-repository.
