...
type DefaultWorkloadIdentityAwsObservation struct {
...
type DefaultWorkloadIdentityAwsParameters struct {
...
type DefaultWorkloadIdentityGCPInitParameters struct {
...
type DefaultWorkloadIdentityGCPObservation struct {
...
type DefaultWorkloadIdentityGCPParameters struct {
...
type ServiceUserDefaultWorkloadIdentityInitParameters struct {
	...
	Oidc []DefaultWorkloadIdentityOidcInitParameters `json:"oidc,omitempty" tf:"oidc,omitempty"`
}

type ServiceUserDefaultWorkloadIdentityObservation struct {

	// (Block List, Max: 1) AWS workload identity configuration. (see below for nested schema)
	// AWS workload identity configuration.
	Aws []DefaultWorkloadIdentityAwsObservation `json:"aws,omitempty" tf:"aws,omitempty"`

	// (Block List, Max: 1) Azure workload identity configuration. (see below for nested schema)
	// Azure workload identity configuration.
	Azure []DefaultWorkloadIdentityAzureObservation `json:"azure,omitempty" tf:"azure,omitempty"`

	// (Block List, Max: 1) GCP workload identity configuration. (see below for nested schema)
	// GCP workload identity configuration.
	GCP []DefaultWorkloadIdentityGCPObservation `json:"gcp,omitempty" tf:"gcp,omitempty"`

	// (Block List, Max: 1) Generic OIDC workload identity configuration. (see below for nested schema)
	// Generic OIDC workload identity configuration.
	Oidc []DefaultWorkloadIdentityOidcObservation `json:"oidc,omitempty" tf:"oidc,omitempty"`
}

type ServiceUserDefaultWorkloadIdentityParameters struct {

	// (Block List, Max: 1) AWS workload identity configuration. (see below for nested schema)
	// AWS workload identity configuration.
	// +kubebuilder:validation:Optional
	Aws []DefaultWorkloadIdentityAwsParameters `json:"aws,omitempty" tf:"aws,omitempty"`

	// (Block List, Max: 1) Azure workload identity configuration. (see below for nested schema)
	// Azure workload identity configuration.
	// +kubebuilder:validation:Optional
	Azure []DefaultWorkloadIdentityAzureParameters `json:"azure,omitempty" tf:"azure,omitempty"`

	// (Block List, Max: 1) GCP workload identity configuration. (see below for nested schema)
	// GCP workload identity configuration.
	// +kubebuilder:validation:Optional
	GCP []DefaultWorkloadIdentityGCPParameters `json:"gcp,omitempty" tf:"gcp,omitempty"`

	// (Block List, Max: 1) Generic OIDC workload identity configuration. (see below for nested schema)
	// Generic OIDC workload identity configuration.
	// +kubebuilder:validation:Optional
	Oidc []DefaultWorkloadIdentityOidcParameters `json:"oidc,omitempty" tf:"oidc,omitempty"`
}
...
type ServiceUserInitParameters struct {
	...
	DefaultWorkloadIdentity []ServiceUserDefaultWorkloadIdentityInitParameters `json:"defaultWorkloadIdentity,omitempty" tf:"default_workload_identity,omitempty"`
...
type ServiceUserObservation struct {
	...
	// party services to authenticate as this user. Only applicable for service users and legacy service users. This field can be only used when USER_ENABLE_DEFAULT_WORKLOAD_IDENTITY option is specified in provider block in the experimental_features_enabled field. If this feature is not enabled, attempting to set this field will result in an error. The provider will not get WIF information from Snowflake. (see below for nested schema)
	// Configures the default workload identity for the user. This is used for workload identity federation to allow third-party services to authenticate as this user. Only applicable for service users and legacy service users. This field can be only used when `USER_ENABLE_DEFAULT_WORKLOAD_IDENTITY` option is specified in provider block in the [`experimental_features_enabled`](../#experimental_features_enabled-1) field. If this feature is not enabled, attempting to set this field will result in an error. The provider will not get WIF information from Snowflake.
	DefaultWorkloadIdentity []ServiceUserDefaultWorkloadIdentityObservation `json:"defaultWorkloadIdentity,omitempty" tf:"default_workload_identity,omitempty"`
	...
	Parameters []ServiceUserParametersObservation `json:"parameters,omitempty" tf:"parameters,omitempty"`
...
type ServiceUserParameters struct {
	...
	// Configures the default workload identity for the user. This is used for workload identity federation to allow third-party services to authenticate as this user. Only applicable for service users and legacy service users. This field can be only used when `USER_ENABLE_DEFAULT_WORKLOAD_IDENTITY` option is specified in provider block in the [`experimental_features_enabled`](../#experimental_features_enabled-1) field. If this feature is not enabled, attempting to set this field will result in an error. The provider will not get WIF information from Snowflake.
	// +kubebuilder:validation:Optional
	DefaultWorkloadIdentity []ServiceUserDefaultWorkloadIdentityParameters `json:"defaultWorkloadIdentity,omitempty" tf:"default_workload_identity,omitempty"`
...
type ServiceUserParametersInitParameters struct {
}

type ServiceUserParametersLogEventLevelInitParameters struct {
}

type ServiceUserParametersLogEventLevelObservation struct {
...
type ServiceUserParametersLogEventLevelParameters struct {
}

type ServiceUserParametersLogLevelInitParameters struct {
}

type ServiceUserParametersLogLevelObservation struct {
...
type ServiceUserParametersLogLevelParameters struct {
}

type ServiceUserParametersObservation struct {
	...
	// insensitive): TRACE | DEBUG | INFO | WARN | ERROR | FATAL | OFF. For more information, check LOG_EVENT_LEVEL docs.
	LogEventLevel []ServiceUserParametersLogEventLevelObservation `json:"logEventLevel,omitempty" tf:"log_event_level,omitempty"`

	// (String) Specifies the severity level of messages that should be ingested and made available in the active event table. Messages at the specified level (and at more severe levels) are ingested. For more information about log levels, see Setting log level. For more information, check LOG_LEVEL docs.
	LogLevel []ServiceUserParametersLogLevelObservation `json:"logLevel,omitempty" tf:"log_level,omitempty"`
	...
	// quoted object identifiers are stored and resolved as uppercase letters. By default, Snowflake preserves the case of alphabetic characters when storing and resolving double-quoted identifiers (see Identifier resolution). You can use this parameter in situations in which third-party applications always use double quotes around identifiers. For more information, check QUOTED_IDENTIFIERS_IGNORE_CASE docs.
	QuotedIdentifiersIgnoreCase []ServiceUserParametersQuotedIdentifiersIgnoreCaseObservation `json:"quotedIdentifiersIgnoreCase,omitempty" tf:"quoted_identifiers_ignore_case,omitempty"`
	...
	// (String) Controls how trace events are ingested into the event table. For more information about trace levels, see Setting trace level. For more information, check TRACE_LEVEL docs.
	TraceLevel []ServiceUserParametersTraceLevelObservation `json:"traceLevel,omitempty" tf:"trace_level,omitempty"`
...
type ServiceUserParametersParameters struct {
}

type ServiceUserParametersQuotedIdentifiersIgnoreCaseInitParameters struct {
}

type ServiceUserParametersQuotedIdentifiersIgnoreCaseObservation struct {
...
type ServiceUserParametersQuotedIdentifiersIgnoreCaseParameters struct {
}

type ServiceUserParametersTraceLevelInitParameters struct {
}

type ServiceUserParametersTraceLevelObservation struct {
...
type ServiceUserParametersTraceLevelParameters struct {
}
