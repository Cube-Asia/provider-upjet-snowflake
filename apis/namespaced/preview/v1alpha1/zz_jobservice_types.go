...
type JobServiceDescribeOutputInitParameters struct {
}

type JobServiceDescribeOutputObservation struct {
...
type JobServiceDescribeOutputParameters struct {
}

type JobServiceInitParameters struct {
...
type JobServiceObservation struct {
	...
	DescribeOutput []JobServiceDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []JobServiceShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}

type JobServiceParameters struct {
...
type JobServiceShowOutputInitParameters struct {
}

type JobServiceShowOutputObservation struct {
...
type JobServiceShowOutputParameters struct {
}
...
type UsingInitParameters struct {
	...
	// (String) The value to assign to the variable in the template. The value must either be alphanumeric or valid JSON. The provider wraps it in $$ by default, so be aware of that while referencing the argument in the spec definition. Using $$ in this field is disallowed.
...
type JobServiceSpec struct {
	...
	ForProvider            JobServiceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider JobServiceInitParameters `json:"initProvider,omitempty"`
}

// JobServiceStatus defines the observed state of JobService.
type JobServiceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        JobServiceObservation `json:"atProvider,omitempty"`
}
...
type JobService struct {
	...
	Spec   JobServiceSpec   `json:"spec"`
	Status JobServiceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// JobServiceList contains a list of JobServices
...
var (
	JobService_Kind             = "JobService"
	JobService_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: JobService_Kind}.String()
	JobService_KindAPIVersion   = JobService_Kind + "." + CRDGroupVersion.String()
	JobService_GroupVersionKind = CRDGroupVersion.WithKind(JobService_Kind)
)
