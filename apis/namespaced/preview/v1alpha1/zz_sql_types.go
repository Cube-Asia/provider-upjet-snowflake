...
type SQLArgumentsInitParameters_2 struct {
...
type SQLArgumentsObservation_2 struct {
...
type SQLArgumentsParameters_2 struct {
...
type SQLInitParameters_2 struct {
	...
	Arguments []SQLArgumentsInitParameters_2 `json:"arguments,omitempty" tf:"arguments,omitempty"`
...
type SQLObservation_2 struct {

	// (Block List) List of the arguments for the procedure. Consult the docs for more details. (see below for nested schema)
	// List of the arguments for the procedure. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-procedure#all-languages) for more details.
	Arguments []SQLArgumentsObservation_2 `json:"arguments,omitempty" tf:"arguments,omitempty"`
	...
	Parameters []SQLParametersObservation_2 `json:"parameters,omitempty" tf:"parameters,omitempty"`
	...
	ShowOutput []SQLShowOutputObservation_2 `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type SQLParametersEnableConsoleOutputInitParameters_2 struct {
}

type SQLParametersEnableConsoleOutputObservation_2 struct {
...
type SQLParametersEnableConsoleOutputParameters_2 struct {
}

type SQLParametersInitParameters_2 struct {
}

type SQLParametersLogEventLevelInitParameters_2 struct {
}

type SQLParametersLogEventLevelObservation_2 struct {
...
type SQLParametersLogEventLevelParameters_2 struct {
}

type SQLParametersLogLevelInitParameters_2 struct {
}

type SQLParametersLogLevelObservation_2 struct {
...
type SQLParametersLogLevelParameters_2 struct {
}

type SQLParametersMetricLevelInitParameters_2 struct {
}

type SQLParametersMetricLevelObservation_2 struct {
...
type SQLParametersMetricLevelParameters_2 struct {
}

type SQLParametersObservation_2 struct {

	// (Boolean) Enable stdout/stderr fast path logging for anonyous stored procs. This is a public parameter (similar to LOG_LEVEL). For more information, check ENABLE_CONSOLE_OUTPUT docs.
	EnableConsoleOutput []SQLParametersEnableConsoleOutputObservation_2 `json:"enableConsoleOutput,omitempty" tf:"enable_console_output,omitempty"`

	// insensitive): TRACE | DEBUG | INFO | WARN | ERROR | FATAL | OFF. For more information, check LOG_EVENT_LEVEL docs.
	LogEventLevel []SQLParametersLogEventLevelObservation_2 `json:"logEventLevel,omitempty" tf:"log_event_level,omitempty"`

	// (String) LOG_LEVEL to use when filtering events For more information, check LOG_LEVEL docs.
	LogLevel []SQLParametersLogLevelObservation_2 `json:"logLevel,omitempty" tf:"log_level,omitempty"`

	// (String) METRIC_LEVEL value to control whether to emit metrics to Event Table For more information, check METRIC_LEVEL docs.
	MetricLevel []SQLParametersMetricLevelObservation_2 `json:"metricLevel,omitempty" tf:"metric_level,omitempty"`

	// (String) Trace level value to use when generating/filtering trace events For more information, check TRACE_LEVEL docs.
	TraceLevel []SQLParametersTraceLevelObservation_2 `json:"traceLevel,omitempty" tf:"trace_level,omitempty"`
}

type SQLParametersParameters_2 struct {
}

type SQLParametersTraceLevelInitParameters_2 struct {
}

type SQLParametersTraceLevelObservation_2 struct {
...
type SQLParametersTraceLevelParameters_2 struct {
}

type SQLParameters_2 struct {

	// (Block List) List of the arguments for the procedure. Consult the docs for more details. (see below for nested schema)
	// List of the arguments for the procedure. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-procedure#all-languages) for more details.
	// +kubebuilder:validation:Optional
	Arguments []SQLArgumentsParameters_2 `json:"arguments,omitempty" tf:"arguments,omitempty"`
...
type SQLShowOutputInitParameters_2 struct {
}

type SQLShowOutputObservation_2 struct {
...
type SQLShowOutputParameters_2 struct {
}

// SQLSpec defines the desired state of SQL
type SQLSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            SQLParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SQLInitParameters_2 `json:"initProvider,omitempty"`
}

// SQLStatus defines the observed state of SQL.
type SQLStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SQLObservation_2 `json:"atProvider,omitempty"`
}
