...
type ProgrammaticAccessTokenObservation struct {
	...
	ShowOutput []ProgrammaticAccessTokenShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type ProgrammaticAccessTokenShowOutputInitParameters struct {
}

type ProgrammaticAccessTokenShowOutputObservation struct {
...
type ProgrammaticAccessTokenShowOutputParameters struct {
}
