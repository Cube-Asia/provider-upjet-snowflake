...
type GrantPrivilegesToShareInitParameters struct {
...
type GrantPrivilegesToShareSpec struct {
	...
	ForProvider     GrantPrivilegesToShareParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GrantPrivilegesToShareInitParameters `json:"initProvider,omitempty"`
}

// GrantPrivilegesToShareStatus defines the observed state of GrantPrivilegesToShare.
type GrantPrivilegesToShareStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GrantPrivilegesToShareObservation `json:"atProvider,omitempty"`
}
...
// GrantPrivilegesToShareList contains a list of GrantPrivilegesToShares
...
var (
	GrantPrivilegesToShare_Kind             = "GrantPrivilegesToShare"
	GrantPrivilegesToShare_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GrantPrivilegesToShare_Kind}.String()
	GrantPrivilegesToShare_KindAPIVersion   = GrantPrivilegesToShare_Kind + "." + CRDGroupVersion.String()
	GrantPrivilegesToShare_GroupVersionKind = CRDGroupVersion.WithKind(GrantPrivilegesToShare_Kind)
)
