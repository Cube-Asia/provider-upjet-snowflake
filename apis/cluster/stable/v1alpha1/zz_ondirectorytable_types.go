...
type OnDirectoryTableDescribeOutputInitParameters struct {
}

type OnDirectoryTableDescribeOutputObservation struct {
...
type OnDirectoryTableDescribeOutputParameters struct {
}
...
type OnDirectoryTableObservation struct {
	...
	DescribeOutput []OnDirectoryTableDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []OnDirectoryTableShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type OnDirectoryTableShowOutputInitParameters struct {
}

type OnDirectoryTableShowOutputObservation struct {
...
type OnDirectoryTableShowOutputParameters struct {
}
