...
type SecondaryDatabaseSpec struct {
	...
	// autoscaler.
	InitProvider SecondaryDatabaseInitParameters `json:"initProvider,omitempty"`
}
...
// SecondaryDatabase is the Schema for the SecondaryDatabases API. A secondary database creates a replica of an existing primary database (i.e. a secondary database). For more information about database replication, see Introduction to database replication across multiple accounts https://docs.snowflake.com/en/user-guide/db-replication-intro.
...
type SecondaryDatabase struct {
	...
	Spec   SecondaryDatabaseSpec   `json:"spec"`
	Status SecondaryDatabaseStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SecondaryDatabaseList contains a list of SecondaryDatabases
...
var (
	SecondaryDatabase_Kind             = "SecondaryDatabase"
	SecondaryDatabase_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SecondaryDatabase_Kind}.String()
	SecondaryDatabase_KindAPIVersion   = SecondaryDatabase_Kind + "." + CRDGroupVersion.String()
	SecondaryDatabase_GroupVersionKind = CRDGroupVersion.WithKind(SecondaryDatabase_Kind)
)
