...
type CurrentOrganizationAccountInitParameters struct {
	...
	// account private connectivity URL for the Snowflake App Service. For more information, see Snowflake documentation. For more information, check ENABLE_PER_ACCOUNT_APP_SERVICE_PRIVATELINK_URL docs.
	...
	EnablePerAccountAppServicePrivatelinkURL *bool `json:"enablePerAccountAppServicePrivatelinkUrl,omitempty" tf:"enable_per_account_app_service_privatelink_url,omitempty"`
...
type CurrentOrganizationAccountObservation struct {
	...
	ShowOutput []CurrentOrganizationAccountShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type CurrentOrganizationAccountParameters struct {
...
type CurrentOrganizationAccountShowOutputInitParameters struct {
}

type CurrentOrganizationAccountShowOutputObservation struct {
...
type CurrentOrganizationAccountShowOutputParameters struct {
}

// CurrentOrganizationAccountSpec defines the desired state of CurrentOrganizationAccount
type CurrentOrganizationAccountSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CurrentOrganizationAccountParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CurrentOrganizationAccountInitParameters `json:"initProvider,omitempty"`
}

// CurrentOrganizationAccountStatus defines the observed state of CurrentOrganizationAccount.
type CurrentOrganizationAccountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CurrentOrganizationAccountObservation `json:"atProvider,omitempty"`
}
...
// CurrentOrganizationAccount is the Schema for the CurrentOrganizationAccounts API. Resource used to manage an organization account within the organization you are connected to. See ALTER ORGANIZATION ACCOUNT https://docs.snowflake.com/en/sql-reference/sql/alter-organization-account documentation for more information on resource capabilities.
...
type CurrentOrganizationAccount struct {
	...
	Spec              CurrentOrganizationAccountSpec   `json:"spec"`
	Status            CurrentOrganizationAccountStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CurrentOrganizationAccountList contains a list of CurrentOrganizationAccounts
type CurrentOrganizationAccountList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CurrentOrganizationAccount `json:"items"`
}

// Repository type metadata.
var (
	CurrentOrganizationAccount_Kind             = "CurrentOrganizationAccount"
	CurrentOrganizationAccount_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CurrentOrganizationAccount_Kind}.String()
	CurrentOrganizationAccount_KindAPIVersion   = CurrentOrganizationAccount_Kind + "." + CRDGroupVersion.String()
	CurrentOrganizationAccount_GroupVersionKind = CRDGroupVersion.WithKind(CurrentOrganizationAccount_Kind)
)

func init() {
	SchemeBuilder.Register(&CurrentOrganizationAccount{}, &CurrentOrganizationAccountList{})
}
