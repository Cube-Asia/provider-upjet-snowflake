...
type OnExternalTableDescribeOutputInitParameters struct {
}

type OnExternalTableDescribeOutputObservation struct {
...
type OnExternalTableDescribeOutputParameters struct {
}
...
type OnExternalTableObservation struct {
	...
	DescribeOutput []OnExternalTableDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []OnExternalTableShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type OnExternalTableShowOutputInitParameters struct {
}

type OnExternalTableShowOutputObservation struct {
...
type OnExternalTableShowOutputParameters struct {
}
