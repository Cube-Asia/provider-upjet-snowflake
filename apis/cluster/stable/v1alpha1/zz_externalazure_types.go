...
type ExternalAzureDescribeOutputInitParameters struct {
}

type ExternalAzureDescribeOutputObservation struct {
...
type ExternalAzureDescribeOutputParameters struct {
}

type ExternalAzureFileFormatInitParameters struct {
...
type ExternalAzureFileFormatObservation struct {
...
type ExternalAzureFileFormatParameters struct {
...
type ExternalAzureInitParameters struct {
	...
	FileFormat []ExternalAzureFileFormatInitParameters `json:"fileFormat,omitempty" tf:"file_format,omitempty"`
...
type ExternalAzureObservation struct {
	...
	DescribeOutput []ExternalAzureDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	// (Block List, Max: 1) Specifies the file format for the stage. (see below for nested schema)
	// Specifies the file format for the stage.
	FileFormat []ExternalAzureFileFormatObservation `json:"fileFormat,omitempty" tf:"file_format,omitempty"`
	...
	ShowOutput []ExternalAzureShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type ExternalAzureParameters struct {
	...
	// Specifies the file format for the stage.
	// +kubebuilder:validation:Optional
	FileFormat []ExternalAzureFileFormatParameters `json:"fileFormat,omitempty" tf:"file_format,omitempty"`
...
type ExternalAzureShowOutputInitParameters struct {
}

type ExternalAzureShowOutputObservation struct {
...
type ExternalAzureShowOutputParameters struct {
}
...
// ExternalAzureSpec defines the desired state of ExternalAzure
type ExternalAzureSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalAzureParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalAzureInitParameters `json:"initProvider,omitempty"`
}

// ExternalAzureStatus defines the observed state of ExternalAzure.
type ExternalAzureStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalAzureObservation `json:"atProvider,omitempty"`
}
...
// ExternalAzure is the Schema for the ExternalAzures API. Resource used to manage external Azure stages. For more information, check external stage documentation https://docs.snowflake.com/en/sql-reference/sql/create-stage#external-stage-parameters-externalstageparams.
...
type ExternalAzure struct {
	...
	Spec   ExternalAzureSpec   `json:"spec"`
	Status ExternalAzureStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalAzureList contains a list of ExternalAzures
type ExternalAzureList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalAzure `json:"items"`
}

// Repository type metadata.
var (
	ExternalAzure_Kind             = "ExternalAzure"
	ExternalAzure_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalAzure_Kind}.String()
	ExternalAzure_KindAPIVersion   = ExternalAzure_Kind + "." + CRDGroupVersion.String()
	ExternalAzure_GroupVersionKind = CRDGroupVersion.WithKind(ExternalAzure_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalAzure{}, &ExternalAzureList{})
}
