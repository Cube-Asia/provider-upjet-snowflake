...
type VolumeDescribeOutputInitParameters struct {
}

type VolumeDescribeOutputObservation struct {
...
type VolumeDescribeOutputParameters struct {
}
...
type VolumeObservation struct {
	...
	DescribeOutput []VolumeDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []VolumeShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type VolumeShowOutputInitParameters struct {
}

type VolumeShowOutputObservation struct {
...
type VolumeShowOutputParameters struct {
}
...
// Volume is the Schema for the Volumes API. Resource used to manage external volume objects. For more information, check external volume documentation https://docs.snowflake.com/en/sql-reference/commands-data-loading#external-volume.
