...
type OnTableAtInitParameters struct {
...
type OnTableAtObservation struct {
...
type OnTableAtParameters struct {
...
type OnTableBeforeInitParameters struct {
...
type OnTableBeforeObservation struct {
...
type OnTableBeforeParameters struct {
...
type OnTableDescribeOutputInitParameters struct {
}

type OnTableDescribeOutputObservation struct {
...
type OnTableDescribeOutputParameters struct {
}
...
type OnTableInitParameters struct {
	...
	At []OnTableAtInitParameters `json:"at,omitempty" tf:"at,omitempty"`
	...
	Before []OnTableBeforeInitParameters `json:"before,omitempty" tf:"before,omitempty"`
...
type OnTableObservation struct {
	...
	// (see below for nested schema)
	// This field specifies that the request is inclusive of any changes made by a statement or transaction with a timestamp equal to the specified parameter. Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	At []OnTableAtObservation `json:"at,omitempty" tf:"at,omitempty"`

	// (see below for nested schema)
	// This field specifies that the request refers to a point immediately preceding the specified parameter. This point in time is just before the statement, identified by its query ID, is completed.  Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	Before []OnTableBeforeObservation `json:"before,omitempty" tf:"before,omitempty"`
	...
	DescribeOutput []OnTableDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []OnTableShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type OnTableParameters struct {
	...
	// This field specifies that the request is inclusive of any changes made by a statement or transaction with a timestamp equal to the specified parameter. Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	// +kubebuilder:validation:Optional
	At []OnTableAtParameters `json:"at,omitempty" tf:"at,omitempty"`

	// (see below for nested schema)
	// This field specifies that the request refers to a point immediately preceding the specified parameter. This point in time is just before the statement, identified by its query ID, is completed.  Due to Snowflake limitations, the provider does not detect external changes on this field. External changes for this field won't be detected.
	// +kubebuilder:validation:Optional
	Before []OnTableBeforeParameters `json:"before,omitempty" tf:"before,omitempty"`
...
type OnTableShowOutputInitParameters struct {
}

type OnTableShowOutputObservation struct {
...
type OnTableShowOutputParameters struct {
}
