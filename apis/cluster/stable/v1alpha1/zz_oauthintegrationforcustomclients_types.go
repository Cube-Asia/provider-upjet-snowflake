...
type AllowedRolesListObservation struct {
...
type AllowedRolesListParameters struct {
}
...
type DescribeOutputNetworkPolicyInitParameters struct {
}

type DescribeOutputNetworkPolicyObservation struct {
...
type DescribeOutputNetworkPolicyParameters struct {
}
...
type OauthIntegrationForCustomClientsDescribeOutputCommentInitParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputCommentObservation struct {
...
type OauthIntegrationForCustomClientsDescribeOutputCommentParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputEnabledInitParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputEnabledObservation struct {
...
type OauthIntegrationForCustomClientsDescribeOutputEnabledParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputInitParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputOauthAuthorizationEndpointInitParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputOauthAuthorizationEndpointObservation struct {
...
type OauthIntegrationForCustomClientsDescribeOutputOauthAuthorizationEndpointParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputOauthRefreshTokenValidityInitParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputOauthRefreshTokenValidityObservation struct {
...
type OauthIntegrationForCustomClientsDescribeOutputOauthRefreshTokenValidityParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputOauthTokenEndpointInitParameters struct {
}

type OauthIntegrationForCustomClientsDescribeOutputOauthTokenEndpointObservation struct {
...
type OauthIntegrationForCustomClientsDescribeOutputOauthTokenEndpointParameters struct {
}
...
type OauthIntegrationForCustomClientsDescribeOutputObservation struct {
	...
	Comment []OauthIntegrationForCustomClientsDescribeOutputCommentObservation `json:"comment,omitempty" tf:"comment,omitempty"`
	...
	Enabled []OauthIntegrationForCustomClientsDescribeOutputEnabledObservation `json:"enabled,omitempty" tf:"enabled,omitempty"`
	...
	NetworkPolicy []DescribeOutputNetworkPolicyObservation `json:"networkPolicy,omitempty" tf:"network_policy,omitempty"`
	...
	// (List of Object) (see below for nested schema)
	OauthAuthorizationEndpoint []OauthIntegrationForCustomClientsDescribeOutputOauthAuthorizationEndpointObservation `json:"oauthAuthorizationEndpoint,omitempty" tf:"oauth_authorization_endpoint,omitempty"`
	...
	OauthRefreshTokenValidity []OauthIntegrationForCustomClientsDescribeOutputOauthRefreshTokenValidityObservation `json:"oauthRefreshTokenValidity,omitempty" tf:"oauth_refresh_token_validity,omitempty"`

	// (List of Object) (see below for nested schema)
	OauthTokenEndpoint []OauthIntegrationForCustomClientsDescribeOutputOauthTokenEndpointObservation `json:"oauthTokenEndpoint,omitempty" tf:"oauth_token_endpoint,omitempty"`
...
type OauthIntegrationForCustomClientsDescribeOutputParameters struct {
}
...
type OauthIntegrationForCustomClientsInitParameters struct {
	...
	OauthRedirectURISecretRef v2.SecretKeySelector `json:"oauthRedirectUriSecretRef" tf:"-"`
...
type OauthIntegrationForCustomClientsObservation struct {
	...
	DescribeOutput []OauthIntegrationForCustomClientsDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	RelatedParameters []OauthIntegrationForCustomClientsRelatedParametersObservation `json:"relatedParameters,omitempty" tf:"related_parameters,omitempty"`
	...
	ShowOutput []OauthIntegrationForCustomClientsShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}
...
type OauthIntegrationForCustomClientsRelatedParametersInitParameters struct {
}

type OauthIntegrationForCustomClientsRelatedParametersObservation struct {
...
type OauthIntegrationForCustomClientsRelatedParametersParameters struct {
}

type OauthIntegrationForCustomClientsShowOutputInitParameters struct {
}

type OauthIntegrationForCustomClientsShowOutputObservation struct {
...
type OauthIntegrationForCustomClientsShowOutputParameters struct {
}
...
// OauthIntegrationForCustomClientsSpec defines the desired state of OauthIntegrationForCustomClients
type OauthIntegrationForCustomClientsSpec struct {
	v2.ClusterManagedResourceSpec `json:",inline"`
	ForProvider                   OauthIntegrationForCustomClientsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OauthIntegrationForCustomClientsInitParameters `json:"initProvider,omitempty"`
}
...
// OauthIntegrationForCustomClients is the Schema for the OauthIntegrationForCustomClientss API. Resource used to manage oauth security integration for custom clients objects. For more information, check security integrations documentation https://docs.snowflake.com/en/sql-reference/sql/create-security-integration-oauth-snowflake.
...
type OauthIntegrationForCustomClients struct {
	...
	Spec   OauthIntegrationForCustomClientsSpec   `json:"spec"`
	Status OauthIntegrationForCustomClientsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OauthIntegrationForCustomClientsList contains a list of OauthIntegrationForCustomClientss
...
var (
	OauthIntegrationForCustomClients_Kind             = "OauthIntegrationForCustomClients"
	OauthIntegrationForCustomClients_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OauthIntegrationForCustomClients_Kind}.String()
	OauthIntegrationForCustomClients_KindAPIVersion   = OauthIntegrationForCustomClients_Kind + "." + CRDGroupVersion.String()
	OauthIntegrationForCustomClients_GroupVersionKind = CRDGroupVersion.WithKind(OauthIntegrationForCustomClients_Kind)
)
