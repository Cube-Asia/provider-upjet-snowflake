...
type CurrentAccountInitParameters struct {
...
type CurrentAccountSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CurrentAccountParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CurrentAccountInitParameters `json:"initProvider,omitempty"`
}

// CurrentAccountStatus defines the observed state of CurrentAccount.
type CurrentAccountStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CurrentAccountObservation `json:"atProvider,omitempty"`
}
...
type CurrentAccount struct {
	...
	Spec              CurrentAccountSpec   `json:"spec"`
	Status            CurrentAccountStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CurrentAccountList contains a list of CurrentAccounts
type CurrentAccountList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CurrentAccount `json:"items"`
}

// Repository type metadata.
var (
	CurrentAccount_Kind             = "CurrentAccount"
	CurrentAccount_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CurrentAccount_Kind}.String()
	CurrentAccount_KindAPIVersion   = CurrentAccount_Kind + "." + CRDGroupVersion.String()
	CurrentAccount_GroupVersionKind = CRDGroupVersion.WithKind(CurrentAccount_Kind)
)

func init() {
	SchemeBuilder.Register(&CurrentAccount{}, &CurrentAccountList{})
}
