...
type StreamlitDescribeOutputInitParameters struct {
}

type StreamlitDescribeOutputObservation struct {
...
type StreamlitDescribeOutputParameters struct {
}
...
type StreamlitObservation struct {
	...
	DescribeOutput []StreamlitDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []StreamlitShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type StreamlitShowOutputInitParameters struct {
}

type StreamlitShowOutputObservation struct {
...
type StreamlitShowOutputParameters struct {
}
