...
type ConnectionInitParameters_2 struct {
...
type ConnectionObservation_2 struct {
	...
	ShowOutput []ConnectionShowOutputObservation_2 `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}

type ConnectionParameters_2 struct {
...
type ConnectionShowOutputInitParameters_2 struct {
}

type ConnectionShowOutputObservation_2 struct {
...
type ConnectionShowOutputParameters_2 struct {
}

// ConnectionSpec defines the desired state of Connection
type ConnectionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ConnectionParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ConnectionInitParameters_2 `json:"initProvider,omitempty"`
}

// ConnectionStatus defines the observed state of Connection.
type ConnectionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ConnectionObservation_2 `json:"atProvider,omitempty"`
}
