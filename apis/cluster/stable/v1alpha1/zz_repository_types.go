...
type RepositoryInitParameters_2 struct {
...
type RepositoryObservation_2 struct {
	...
	ShowOutput []RepositoryShowOutputObservation_2 `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}

type RepositoryParameters_2 struct {
...
type RepositoryShowOutputInitParameters_2 struct {
}

type RepositoryShowOutputObservation_2 struct {
...
type RepositoryShowOutputParameters_2 struct {
}

// RepositorySpec defines the desired state of Repository
type RepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RepositoryParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RepositoryInitParameters_2 `json:"initProvider,omitempty"`
}

// RepositoryStatus defines the observed state of Repository.
type RepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RepositoryObservation_2 `json:"atProvider,omitempty"`
}
