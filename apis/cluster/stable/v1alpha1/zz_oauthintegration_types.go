...
type OauthIntegrationDescribeOutputCommentInitParameters struct {
}

type OauthIntegrationDescribeOutputCommentObservation struct {
...
type OauthIntegrationDescribeOutputCommentParameters struct {
}

type OauthIntegrationDescribeOutputEnabledInitParameters struct {
}

type OauthIntegrationDescribeOutputEnabledObservation struct {
...
type OauthIntegrationDescribeOutputEnabledParameters struct {
}

type OauthIntegrationDescribeOutputInitParameters struct {
}

type OauthIntegrationDescribeOutputObservation struct {

	// (String) Specifies a comment for the OAuth integration.
	Comment []OauthIntegrationDescribeOutputCommentObservation `json:"comment,omitempty" tf:"comment,omitempty"`

	// (Boolean) Specifies whether to initiate operation of the integration or suspend it.
	Enabled []OauthIntegrationDescribeOutputEnabledObservation `json:"enabled,omitempty" tf:"enabled,omitempty"`
...
type OauthIntegrationDescribeOutputParameters struct {
}
...
type OauthIntegrationObservation struct {
	...
	DescribeOutput []OauthIntegrationDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []OauthIntegrationShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}
...
type OauthIntegrationShowOutputInitParameters struct {
}

type OauthIntegrationShowOutputObservation struct {
...
type OauthIntegrationShowOutputParameters struct {
}
