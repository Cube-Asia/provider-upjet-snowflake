...
type LifecyclePolicyDescribeOutputInitParameters struct {
}

type LifecyclePolicyDescribeOutputObservation struct {
...
type LifecyclePolicyDescribeOutputParameters struct {
}
...
type LifecyclePolicyObservation struct {
	...
	DescribeOutput []LifecyclePolicyDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []LifecyclePolicyShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
}
...
type LifecyclePolicyShowOutputInitParameters struct {
}

type LifecyclePolicyShowOutputObservation struct {
...
type LifecyclePolicyShowOutputParameters struct {
}
...
// LifecyclePolicy is the Schema for the LifecyclePolicys API. Resource used to manage storage lifecycle policy objects. For more information, check storage lifecycle policy documentation https://docs.snowflake.com/en/sql-reference/sql/create-storage-lifecycle-policy.
