...
type TableConstraintInitParameters struct {
...
type TableConstraintParameters struct {
...
// TableConstraintSpec defines the desired state of TableConstraint
type TableConstraintSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     TableConstraintParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider TableConstraintInitParameters `json:"initProvider,omitempty"`
}

// TableConstraintStatus defines the observed state of TableConstraint.
type TableConstraintStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        TableConstraintObservation `json:"atProvider,omitempty"`
}
...
type TableConstraint struct {
	...
	Spec   TableConstraintSpec   `json:"spec"`
	Status TableConstraintStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// TableConstraintList contains a list of TableConstraints
...
var (
	TableConstraint_Kind             = "TableConstraint"
	TableConstraint_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: TableConstraint_Kind}.String()
	TableConstraint_KindAPIVersion   = TableConstraint_Kind + "." + CRDGroupVersion.String()
	TableConstraint_GroupVersionKind = CRDGroupVersion.WithKind(TableConstraint_Kind)
)
