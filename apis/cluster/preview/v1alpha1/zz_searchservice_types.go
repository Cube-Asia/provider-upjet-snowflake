...
type SearchServiceDescribeOutputInitParameters struct {
}

type SearchServiceDescribeOutputObservation struct {
...
type SearchServiceDescribeOutputParameters struct {
}
...
type SearchServiceObservation struct {
	...
	DescribeOutput []SearchServiceDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
