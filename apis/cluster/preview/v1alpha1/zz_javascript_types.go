...
type JavascriptArgumentsInitParameters_2 struct {
...
type JavascriptArgumentsObservation_2 struct {
...
type JavascriptArgumentsParameters_2 struct {
...
type JavascriptInitParameters_2 struct {
	...
	Arguments []JavascriptArgumentsInitParameters_2 `json:"arguments,omitempty" tf:"arguments,omitempty"`
...
type JavascriptObservation_2 struct {

	// (Block List) List of the arguments for the procedure. Consult the docs for more details. (see below for nested schema)
	// List of the arguments for the procedure. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-procedure#all-languages) for more details.
	Arguments []JavascriptArgumentsObservation_2 `json:"arguments,omitempty" tf:"arguments,omitempty"`
	...
	Parameters []JavascriptParametersObservation_2 `json:"parameters,omitempty" tf:"parameters,omitempty"`
	...
	ShowOutput []JavascriptShowOutputObservation_2 `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type JavascriptParametersEnableConsoleOutputInitParameters struct {
}

type JavascriptParametersEnableConsoleOutputObservation struct {
...
type JavascriptParametersEnableConsoleOutputParameters struct {
}

type JavascriptParametersInitParameters_2 struct {
}

type JavascriptParametersLogEventLevelInitParameters struct {
}

type JavascriptParametersLogEventLevelObservation struct {
...
type JavascriptParametersLogEventLevelParameters struct {
}

type JavascriptParametersLogLevelInitParameters struct {
}

type JavascriptParametersLogLevelObservation struct {
...
type JavascriptParametersLogLevelParameters struct {
}

type JavascriptParametersMetricLevelInitParameters struct {
}

type JavascriptParametersMetricLevelObservation struct {
...
type JavascriptParametersMetricLevelParameters struct {
}

type JavascriptParametersObservation_2 struct {

	// (Boolean) Enable stdout/stderr fast path logging for anonyous stored procs. This is a public parameter (similar to LOG_LEVEL). For more information, check ENABLE_CONSOLE_OUTPUT docs.
	EnableConsoleOutput []JavascriptParametersEnableConsoleOutputObservation `json:"enableConsoleOutput,omitempty" tf:"enable_console_output,omitempty"`

	// insensitive): TRACE | DEBUG | INFO | WARN | ERROR | FATAL | OFF. For more information, check LOG_EVENT_LEVEL docs.
	LogEventLevel []JavascriptParametersLogEventLevelObservation `json:"logEventLevel,omitempty" tf:"log_event_level,omitempty"`

	// (String) LOG_LEVEL to use when filtering events For more information, check LOG_LEVEL docs.
	LogLevel []JavascriptParametersLogLevelObservation `json:"logLevel,omitempty" tf:"log_level,omitempty"`

	// (String) METRIC_LEVEL value to control whether to emit metrics to Event Table For more information, check METRIC_LEVEL docs.
	MetricLevel []JavascriptParametersMetricLevelObservation `json:"metricLevel,omitempty" tf:"metric_level,omitempty"`

	// (String) Trace level value to use when generating/filtering trace events For more information, check TRACE_LEVEL docs.
	TraceLevel []JavascriptParametersTraceLevelObservation `json:"traceLevel,omitempty" tf:"trace_level,omitempty"`
}

type JavascriptParametersParameters_2 struct {
}

type JavascriptParametersTraceLevelInitParameters struct {
}

type JavascriptParametersTraceLevelObservation struct {
...
type JavascriptParametersTraceLevelParameters struct {
}

type JavascriptParameters_2 struct {

	// (Block List) List of the arguments for the procedure. Consult the docs for more details. (see below for nested schema)
	// List of the arguments for the procedure. Consult the [docs](https://docs.snowflake.com/en/sql-reference/sql/create-procedure#all-languages) for more details.
	// +kubebuilder:validation:Optional
	Arguments []JavascriptArgumentsParameters_2 `json:"arguments,omitempty" tf:"arguments,omitempty"`
...
type JavascriptShowOutputInitParameters_2 struct {
}

type JavascriptShowOutputObservation_2 struct {
...
type JavascriptShowOutputParameters_2 struct {
}

// JavascriptSpec defines the desired state of Javascript
type JavascriptSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     JavascriptParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider JavascriptInitParameters_2 `json:"initProvider,omitempty"`
}

// JavascriptStatus defines the observed state of Javascript.
type JavascriptStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        JavascriptObservation_2 `json:"atProvider,omitempty"`
}
