...
type StageInitParameters struct {
	...
	Tag []StageTagInitParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type StageObservation struct {
	...
	// (Block List, Deprecated) Definitions of a tag to associate with the resource. (see below for nested schema)
	// Definitions of a tag to associate with the resource.
	Tag []StageTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type StageParameters struct {
	...
	// Definitions of a tag to associate with the resource.
	// +kubebuilder:validation:Optional
	Tag []StageTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type StageTagInitParameters struct {
...
type StageTagObservation struct {
...
type StageTagParameters struct {
