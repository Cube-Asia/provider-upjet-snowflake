...
type InstanceDescribeOutputInitParameters struct {
}

type InstanceDescribeOutputObservation struct {
...
type InstanceDescribeOutputParameters struct {
}
...
type InstanceObservation struct {
	...
	DescribeOutput []InstanceDescribeOutputObservation `json:"describeOutput,omitempty" tf:"describe_output,omitempty"`
	...
	ShowOutput []InstanceShowOutputObservation `json:"showOutput,omitempty" tf:"show_output,omitempty"`
...
type InstanceShowOutputInitParameters struct {
}

type InstanceShowOutputObservation struct {
...
type InstanceShowOutputParameters struct {
}
...
// Instance is the Schema for the Instances API. Resource used to manage Postgres instance objects. For more information, check Postgres instance documentation https://docs.snowflake.com/en/sql-reference/sql/create-postgres-instance.
